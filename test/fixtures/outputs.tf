...
output "test_two_random_app_service" {
  value = module.test_two_random.names["azurerm_app_service"]
}

output "test_two_random_storage_account" {
  value = module.test_two_random.names["azurerm_storage_account"]
}

output "test_two_random_subnet" {
  value = module.test_two_random.names["azurerm_subnet"]
}

output "test_two_random_virtual_network" {
  value = module.test_two_random.names["azurerm_virtual_network"]
}
